...
INSERT INTO WalkRequests (dog_id, requested_time, duration_minutes, location, status) (SELECT dog_id, '2025-06-10 07:20:00', 20, 'Adelaide Uni', 'open' FROM Dogs WHERE name = 'Fred');